var config = {
	...
	kost: ['AK', 'EK', 'NNR', 'Timbal', 'Klar Flyt', 'Flyt', 'ND', 'PN'],
	...
	extrafarger: ['#FFFF00', '#0000FF', '#FF0000', '#00FF00'],
	icotodo:[{
		namn: 'eras',
		title: 'ERAS-patient',
		typ: 'none',
		...
		{
		namn: 'o2',
		title: 'Syrgasbehandling',
		typ: 'none',
		info: 'none',
		active: ['getmoreinfo', 'kontroller', 'POX', 'number', '1', 'Hur ofta om dagen ska POX följas?'],
		deactive: 'none',
		toprint: 'aktuellt'},
		{
		namn: 'horsel',
